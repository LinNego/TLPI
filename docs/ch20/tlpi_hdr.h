...
#include "../TLPI/get_num.h"    /* Declares our functions for handling numeric
                           arguments (getInt(), getLong()) */

#include "../TLPI/error_functions.h"  /* Declares our error-handling functions */

#include "../TLPI/signal_functions.h"
#ifndef MAXLINE
#define MAXLINE 4096
#endif
